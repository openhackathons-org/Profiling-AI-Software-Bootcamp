"""Intro lab v2 (fixed): Bug 2 resolved.

Diff vs train_v2.py:
    torch.autograd.set_detect_anomaly(True)  ->  (removed)

Expected behavior:
    - Backward pass is ~2-3× faster: anomaly-detection syncs gone.
    - AMP delivers the expected ~2× speedup over FP32 (train_v1_fixed.py).

Usage:
    python train_v2_fixed.py
"""
